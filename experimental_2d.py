...
class AirfoilTest: 
    def __init__(self, run_nr, alpha, rho, p_pressureSide, p_suctionSide, p_total_wake, p_static_wake, p_pitot_total, p_pitot_static, p_barometric, delta_p_b):
        ...
        self.cp_axial_suctionSide_distribution = interpolate.interp1d(ports_loc_suctionSide_2d, c_p_axial__suctionSide_arr, kind="quadratic", fill_value = "extrapolate")
        self.cp_normal_suctionSide_distribution = interpolate.interp1d(ports_loc_suctionSide_2d, c_p_normal__suctionSide_arr, kind="quadratic", fill_value = "extrapolate")
        
        self.cp_axial_pressureSide_distribution = interpolate.interp1d(ports_loc_pressureSide_2d, c_p_axial__pressureSide_arr, kind="quadratic", fill_value = "extrapolate")
        self.cp_normal_pressureSide_distribution = interpolate.interp1d(ports_loc_pressureSide_2d, c_p_normal__pressureSide_arr, kind="quadratic", fill_value = "extrapolate")
